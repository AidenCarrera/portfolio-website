...
export default function HomeClient({ profile }: HomeClientProps) {
  ...
  return (
    <div className="flex-1 flex flex-col justify-center bg-linear-to-br bg-animated-dark pt-6 sm:pt-4 pb-6 sm:pb-8 min-h-[calc(100vh-4rem-3.5rem)] lg:h-[calc(100dvh-4rem-3.5rem)] lg:min-h-0 lg:overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-1 flex flex-col justify-center lg:-translate-y-3">
